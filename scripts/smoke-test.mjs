...
async function run() {
  ...
  console.log('\n2. Database schema')
  const tables = ['profiles', 'properties', 'property_status', 'stays', 'service_requests', 'service_request_comments', 'guest_reports', 'audit_log', 'property_checklist_items', 'property_contacts']
