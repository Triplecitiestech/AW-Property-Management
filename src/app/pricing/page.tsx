...
const faqs = [
  ...
  },
  {
    ...
    a: 'Absolutely. Smart Sumi is built for property managers with portfolios of any size. Your base plan covers 3 properties, and each additional one is just $10/month.',
  },
  {
    ...
    <div className="min-h-screen bg-[#07101e] text-white overflow-x-hidden">
      ...
      <footer className="border-t border-white/5 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row
          ...
          <p>© {new Date().getFullYear()} Smart Sumi. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
